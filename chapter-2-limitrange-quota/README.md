...
echo "✅ Pod deployed without resource specs"
```
...
echo "📊 Automatically Applied Resources:"
kubectl get pod defaulted-pod -n limitrange-demo -o jsonpath='{.spec.containers[0].resources}' | jq

# Detailed view
kubectl describe pod defaulted-pod -n limitrange-demo | grep -A 10 "Limits\|Requests"
```
...
echo "📊 Pod Count:"
kubectl get pods -n quota-demo --no-headers | wc -l
...
echo -e "\n📋 ReplicaSet Events:"
kubectl get events -n quota-demo --sort-by='.lastTimestamp' | grep -i quota
```
...
echo "✅ Team A quota and limits created"
...
echo "✅ Team B quota and limits created"
```
...
# Compare quotas
echo "📊 Team A Quota Usage:"
kubectl describe resourcequota team-a-quota -n team-a | grep -A 10 "Used"

echo -e "\n📊 Team B Quota Usage:"
kubectl describe resourcequota team-b-quota -n team-b | grep -A 10 "Used"

# Compare actual pod resources
echo -e "\n📊 Team A Pod Resources:"
